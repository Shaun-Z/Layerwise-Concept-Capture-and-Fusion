...
class ATimmWrapper(CopyAttrWrapper):
    ...
    Key differences from TimmWrapper:
    - Uses torch.autograd.grad to compute gradients of attention weights during forward
    - Supports async computation via ThreadPoolExecutor
    - Concept vectors can be set before forward to enable early gradient computation
    """
    def __init__(self, model: Any, layer_indices: Optional[List[int]] = None, include_private: bool = False,
