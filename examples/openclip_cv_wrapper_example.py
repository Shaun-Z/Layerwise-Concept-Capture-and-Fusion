# %%
"""
OpenCLIPCVWrapper Example Script

This script demonstrates how to use the OpenCLIPCVWrapper from the LCCF library.
OpenCLIPCVWrapper propagates gradients backward from the last layer through ALL layers,
...
import torch
import open_clip
from lccf.backends.openclip.wrapper import OpenCLIPCVWrapper
...
wrapper = OpenCLIPCVWrapper(model, layer_indices=layer_indices)
